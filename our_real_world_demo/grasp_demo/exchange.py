...
class GraspModel():
    ...
    def grasp_object(self,category):
        ...
        pose_4_5 = [0.04471478791559428, 0.6940426239214446, 0.45943466790935444, -1.2140166677927158, -0.3121035602415347, 1.889482771065437, 1.3566741845200565]
        self.reset_pose(pose_4_5,grasp=False)
        self.reset_pose(self._pose,grasp=False)
        
        pose_5 = [-0.12650978760761128, 0.013509868126427918, 0.46429503824381224, -2.103918278777395, -5.988930763535497e-05, 2.1520112538602616, 1.2330415283247]
